...
import type { YuiMessage } from '../structures/Tmi/YuiMessage';
import type { YuiUser } from '../structures/Tmi/YuiUser';
...
export class Args {
	 ...
	 */
	public readonly message: YuiMessage;
	...
	public constructor(message: YuiMessage, command: Command, parser: Lexure.Args, context: Command.RunContext) {
